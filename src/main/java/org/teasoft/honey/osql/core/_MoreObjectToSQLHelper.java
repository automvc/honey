...
//					Logger.warn("MoreTable subTable's type is List, paging maybe not accurate!"); //TODO
//				}
//			}
//
//			if (condition != null) {
...
//			if (!needAdjustPageForList) adjustTableNameForShardingIfNeed(tableName, sqlBuffer); // sqlBuffer  TODO 没有转换，是否分片有问题？
//
