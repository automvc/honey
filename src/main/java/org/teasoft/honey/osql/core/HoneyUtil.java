...
//	private static PropertiesReader jdbcTypeCustomProp_specificalDB = null;
	...
	private static void initSetParaAndResultTypeHandlerRegistry() {
		...
		SetParaTypeConverterRegistry.register(java.util.Date.class,
				new UtilDotDateTypeToTimestampConvert<java.util.Date>(), DatabaseConst.PostgreSQL);
		SetParaTypeConverterRegistry.register(java.util.Date.class,
				new UtilDotDateTypeToTimestampConvert<java.util.Date>(), DatabaseConst.H2);
...
//				V1.17 添加单引号转义;双引号不需要转;
	...
	static String checkAndProcessSelectFieldViaString(String columnsdNames, Map<String, String> subDulFieldMap,
			String... fields) {
...
//			if (isSkipFieldForMoreTable(field[i])) continue; //JoinTable可以与PrimaryKey合用? 实际不会同时用
	...
	private final static String NumberArrayTypes[] = { "[Ljava.lang.Long;", "[Ljava.lang.Integer;", "[Ljava.lang.Short;",
			"[Ljava.lang.Byte;", "[Ljava.lang.Double;", "[Ljava.lang.Float;", "[Ljava.math.BigInteger;",
