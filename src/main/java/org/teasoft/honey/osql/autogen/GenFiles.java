...
public class GenFiles {
	...
	public static void genFile(String templatePath, Map<String, String> map, String targetFilePath, String startToken,
			String endToken) {
...
//		try (InputStream inputStream = GenCode.class.getResourceAsStream(filePath); //不行
		try (InputStream inputStream = GenFiles.class.getClassLoader().getResourceAsStream(filePath);
